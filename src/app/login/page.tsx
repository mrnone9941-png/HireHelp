      ...
      <div className="flex min-h-[calc(100vh-128px)] items-center justify-center">
        ...
        >
          <div className="mb-8 text-center">
            ...
            <h1 className="mt-2 text-3xl font-black text-slate-950">Sign in to HireHelp</h1>
            <p className="mt-3 text-sm leading-6 text-muted-foreground">
              Pick up your practice history and keep building interview confidence.
            </p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            New to HireHelp? <Link href="/register" className="font-semibold text-primary hover:underline">Create an account</Link>
          </p>
        </motion.div>
      </div>
    </main>
